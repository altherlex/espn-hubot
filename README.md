...
espn-hubot is a chat bot built on the [Hubot][hubot] framework. It was
...
[Access live]: https://polar-oasis-27660.herokuapp.com/

### Running espn-hubot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start espn-hubot locally by running:
...
Then you can interact with espn-hubot by typing `espn-hubot help`.

    espn-hubot> espn-hubot help
    espn-hubot animate me <query> - The same thing as `image me`, except adds [snip]
